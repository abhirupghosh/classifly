from inference.llm.openai import call_openai
from inference.llm.anthropic import call_anthropic
import logging

def call_llm(messages: list[dict], system_message: str = None, model: str = None, max_tokens: int = 1024, provider: str = "openai"):
    """
